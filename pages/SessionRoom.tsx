...
const SessionRoom: React.FC = () => {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10">
            <h1 className="text-3xl font-bold text-neutral-900 mb-2">Session Room</h1>
            <p className="text-neutral-600 mb-6">Session ID: {sessionId}</p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div>
                    <Card className="p-6">
                        ...
                        <div className="bg-primary-light p-4 rounded-lg min-h-[100px] flex items-center justify-center">
                            {isLoading ? (
                                <p className="text-neutral-600 italic">Generating...</p>
                            ) : (
                                <p className="text-center text-primary-dark font-medium text-lg">"{starter}"</p>
                            )}
                        </div>

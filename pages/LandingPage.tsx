            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold text-neutral-900">A smarter way to connect</h2>
                        <p className="mt-4 text-lg text-neutral-600">AlmaSphere is built to foster meaningful connections that accelerate your career.</p>
                    </div>
